            ...
            <div class="w-full lg:w-1/2 px-4 mb-6 lg:mb-0">
              <div class="px-8 py-10 mb-6 bg-white rounded-3xl shadow-lg">
                <button class="flex group w-full items-start justify-between text-left">
                  ...
                  <div>
                    <span class="flex h-9 w-9 items-center justify-center rounded-full bg-pink-400 text-white">
              ...
              <div class="px-8 py-10 mb-6 bg-white rounded-3xl shadow-lg">
                <button class="flex group w-full items-start justify-between text-left">
                  <div class="max-w-xl pr-5">
                    <h3 class="text-xl font-semibold text-black group-hover:text-pink-400">
                  ...
                  <div>
                    <span class="flex h-9 w-9 items-center justify-center rounded-full bg-pink-200 text-pink-400 group-hover:bg-pink-400 group-hover:text-white transition duration-200">
              ...
              <div class="px-8 py-10 bg-white rounded-3xl shadow-lg">
                <button class="flex group w-full items-start justify-between text-left">
                  ...
                  <div>
                    <span class="flex h-9 w-9 items-center justify-center rounded-full bg-pink-200 text-pink-400 group-hover:bg-pink-400 group-hover:text-pink-200 transition duration-200">
                      <span class="hidden group-hover:block">
                        <svg
                          width="17"
                          height="3"
